...
const diff = (oldObject, newObject) => {
    ...
    keys.forEach((key) => {
        ...
        if (oldValue === undefined) {
            ...
            var subPatch = (0, exports.diff)(oldValue, newValue);
 ...
 */
const patch = (oldObject, diffData) => {
    ...
    keys.forEach((key) => {
        ...
        if (keyNumber >= 0) {
            if (keyNumber >= newObject.length) {
                ...
                newObject[keyNumber] = (0, exports.patch)(newObject[keyNumber], newValue);
            }
        }
        else {
            ...
            if (typeof newValue === 'object') {
                newObject[key] = (0, exports.patch)(newObject[key], newValue);
            }
            else {
                newObject[key] = newValue;
            }
